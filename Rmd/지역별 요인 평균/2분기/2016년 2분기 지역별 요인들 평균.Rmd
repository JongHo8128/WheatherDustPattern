...
analysis_sido <- analysis_total %>% filter(substr(일시,1,7)=='2016-03'|substr(일시,1,7)=='2016-04'|substr(일시,1,7)=='2016-05') %>% group_by(시도코드,시도) %>% summarise(`평균기온(°C)` = mean(`평균기온(°C)`,na.rm=TRUE),

...
# 기상 데이터 가져오기
#----------------------------------------
df_2016 <- read_csv("../../lawdata/weather/기상관측_2016_Fixed.csv",locale=locale('ko',encoding='euc-kr'))
df_2017 <- read_csv("../../lawdata/weather/기상관측_2017_Fixed.csv",locale=locale('ko',encoding='euc-kr'))
df_2018 <- read_csv("../../lawdata/weather/기상관측_2018_Fixed.csv",locale=locale('ko',encoding='euc-kr'))
...
climate_total<- inner_join(weather_concat,dust_total,by=c("일시","시도코드","시도"))
